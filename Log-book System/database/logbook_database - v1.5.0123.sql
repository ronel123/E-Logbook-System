...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 25, 2023 at 11:41 AM
...
--
-- Dumping data for table `form137file_tbl`
--

INSERT INTO `form137file_tbl` (`id`, `created`, `first_name`, `middle_name`, `last_name`, `gradelevel`, `previous_school`, `status`) VALUES
(1, '2023-01-25 08:47:09', 'Ronel', 'Coderes', 'Tagala', 'Grade 12 to College', 'M.S.E.U.F Catanauan, Quezon', 'Incoming');
...
--
-- Dumping data for table `randomfile_tbl`
--

INSERT INTO `randomfile_tbl` (`id`, `created`, `typeofdocuments`, `receivedby`, `remarks`, `status`) VALUES
(1, '2023-01-25 08:46:11', 'Birth Certification', 'Ronel Tagala', 'N/A', 'Completed');
...
(1, '2023-01-24 15:38:35', 'admin', 'admin', 'roneltagala0@gmail.com', 1);
...
(1, '2023-01-25 08:52:47', 'Ronel Tagala', 'Coderes', 'Tagala', 'Male', 1);
